...
class ChromiumVideoRenderer extends events_1.EventEmitter {
    constructor(args, _frameSink) {
        ...
        let context = `${this.constructor.name} #${getUniqueId()}`;
        let childLogger = (args.logger || new NoopLogger()).createChild(context);
    ...
    _initialize(args) {
        ...
        let bufferName = this._frameSink.getBufferName();
    ...
    _checkRendererSize() {
        ...
        let ratio = this._videoElement.rendererWidth / this._videoElement.rendererHeight;
        ...
        let rendererWidth = Math.floor(pixelWidth) || 0;
        let rendererHeight = Math.floor(pixelHeight) || 0;
