...
const utils_2 = require("../vslsChat/utils");
    ...
    constructor(store, providerName, teamId, chatProvider, parentManager) {
        ...
        this.initializeProvider = async () => {
            ...
            if (this.providerName === "vsls") {
                this.store.updateLastChannelId(this.providerName, utils_2.VSLS_CHAT_CHANNEL.id);
            }
            return currentUser;
        };
        ...
        this.updatePresenceForUser = (userId, presence) => {
            ...
            if (userId in users) {
                ...
                if (existingPresence === "invisible" /* invisible */ &&
                ...
                if (!!this.parentManager.vslsContactProvider) {
                    this.parentManager.vslsContactProvider.notifyPresenceChanged(this.store.getUser(this.providerName, userId));
                }
            }
        };
