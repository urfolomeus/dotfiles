...
const ideExtensionProvider_1 = require("../src/ideExtensionProvider");
const vscode_mock = require("./vscode_mock");
describe("IdeExtensionProvider", () => {
    ...
    describe(".removeFromDiagnosticCollection", () => {
        ...
        beforeEach(() => {
            ...
            ideExtensionProvider = new ideExtensionProvider_1.default(mockCollection, mockCommand);
        });
    ...
    describe(".activate", () => {
        ...
        beforeEach(() => {
            ideExtensionProvider = new ideExtensionProvider_1.default({}, {});
        });
...
//# sourceMappingURL=ideExtensionProvider_spec.js.map