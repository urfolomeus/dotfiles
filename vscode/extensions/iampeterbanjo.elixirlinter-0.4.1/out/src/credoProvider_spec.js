...
const credoProvider_1 = require("../src/credoProvider");
const vscodeMock = require("./vscode_mock");
describe("CredoProvider", () => {
    describe(".getDiagnosticInfo", () => {
        let credo;
        beforeEach(() => {
            credo = new credoProvider_1.default(vscodeMock);
        });
    ...
    describe(".makeZeroIndex", () => {
        const credo = new credoProvider_1.default(vscodeMock);
...
//# sourceMappingURL=credoProvider_spec.js.map